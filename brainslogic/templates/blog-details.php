        ...
        <div class="row g-lg-4 gy-5">
            <div class="col-lg-8">
                <div class="blog-details-content">
                    ...
                    <p>Suspendisse bibendum efficitur orci, a pretium erat mattis nec. Vestibulum antema ypsumi primis
                        inaetahsjanoti faucibus orci luctus etenjot ultrices posuere cubilia andt</p>
                    <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh elementum, accumsan
                        ona
                        neque ac, aliquet nunc. In eu ipsum fringilla, accumsan purus vel, pellentesque risus. Vivamus
                        vehicula nl
                        purus at eros interdum, in dignissim nulla vestibulum. Nunc sit amet finibus felis, ut egestas
                        lacus. Sedan
                        pellentesque quis magna eu vestibulum. Ut sed commodo neque. Morbi erat nisi, vehicula quis
                        faucibus il aliquet nunc. In eu ipsum fringilla, accumsan purus vel, pellentesque risus. Vivamus
                        vehicula noted by thi
                        ut, hendrerit vel tortor. In pharetra lectus luctus ornare sollicitudin.</p>
                    <blockquote>
                        <p>"I work with Alguneb Johnl on many projects, he always beeni toldagona exci my expectations
                            with his quality work and fastestopa tope service, very smooth and simple."</p>
                    ...
                    <p> urna Aenean onewaryzo eleifend vitae tellus a facilisis. Nunc posuere at augue eget onem porta.
                        Inei odio goral tubeleti tellus, dignissim fermentumara purus nec, consequat dapibus toura gonem
                        metus.Vivamus urna worlda mauris, faucibus at egestas quis, fermentum egetonav nequet Duis
                        pharetra lectus nec risusonl pellentesque, toi vitae aliquet nisi dapibus. Sed volutpat mot
                        velit, ateng maximus est eleifend accui Fusce porttitor ex archunabo. dignissim fermentumara
                        purus nec, consequat dapibus toura gonem metus.Vivamus urna worlda Phasellus one viverra lorem
                        ant nibh placerat tincidunt.bolgotai Aliquam andit rutrum.</p>
                    ...
                    <p>urna Aenean onewaryzo eleifend vitae tellus a facilisis. Nunc posuere at augue eget portat Inei
                        odio tellus, dignissim fermentumara purus nec, consequat dapibus metus.Vivamus one urna worlda
                        mauris, faucibus at egestas quis, fermentum egetonav neque.</p>
                    <div class="blog-tag-and-social">
                        <div class="tag">
                            <h6>Tag:</h6>
                            <ul>
                                <li><a href="blogs.php">Software</a></li>
                                <li><a href="blogs.php">Marketing</a></li>
                                <li><a href="blogs.php">Cyber</a></li>
                                <li><a href="blogs.php">Development</a></li>
                            </ul>
                        </div>
                        <div class="social">
                            <h6>Share On:</h6>
                ...
                <div class="widget-area">
                    ...
                    <div class="single-widgets widget_egns_categoris">
                        ...
                        <ul class="wp-block-categoris-cloud">
                            <li><a href="blogs.php"><span>Web Design</span> <span
                                            class="number-of-categoris">(30)</span></a></li>
                            <li><a href="blogs.php"><span>Apps Development</span> <span
                                            class="number-of-categoris">(18)</span> </a></li>
                            <li><a href="blogs.php"><span>Software Development</span> <span class="number-of-categoris">(21)</span></a>
                            </li>
                            <li><a href="blogs.php"><span>Motion Graphics</span> <span
                                            class="number-of-categoris">(25)</span></a></li>
                            <li><a href="blogs.php"><span>UI/UX Design</span> <span
                                            class="number-of-categoris">(29)</span></a></li>
                            <li><a href="blogs.php"><span>UI/UX Design</span> <span
                                            class="number-of-categoris">(31)</span></a></li>
                        </ul>
                    </div>
                    <div class="single-widgets widget_egns_recent_post">
                        ...
                        <div class="recent-post-wraper">
                            <div class="widget-cnt">
                                <div class="wi">
                                    <a href="blog-details.php"><img src="assets/img/inner-pages/blog-sidebar-1.png"
                                                                    alt="image"></a>
                                </div>
                                <div class="wc">
                                    <h6><a href="blog-details.php">Grant Distributions Conti nu to Incr Ease.</a></h6>
                                    <a href="blogs.php">May 18, 2023</a>
                                </div>
                            </div>
                            <div class="widget-cnt">
                                <div class="wi">
                                    <a href="blog-details.php"><img src="assets/img/inner-pages/blog-sidebar-2.png"
                                                                    alt="image"></a>
                                </div>
                                <div class="wc">
                                    <h6><a href="blog-details.php">Distributions Conti nu to grant Incr Ease.</a></h6>
                                    <a href="blogs.php">May 15, 2023</a>
                                </div>
                            </div>
                            <div class="widget-cnt">
                                <div class="wi">
                                    <a href="blog-details.php"><img src="assets/img/inner-pages/blog-sidebar-3.png"
                                                                    alt="image"></a>
                                </div>
                                <div class="wc">
                                    <h6><a href="blog-details.php">Conti nu to Incr Ease malesuada sapien sed.</a></h6>
                                    <a href="blogs.php">May 14, 2023</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="single-widgets widget_egns_tag">
                        ...
                        <p class="wp-block-tag-cloud">
                            <a href="blogs.php">Website</a>
                            <a href="blogs.php">Web Design</a>
                            <a href="blogs.php">Development</a>
                            <a href="blogs.php">Graphic Design</a>
                            <a href="blogs.php">Graphic</a>
                            <a href="blogs.php">UI/UX Design</a>
                            <a href="blogs.php">Activities</a>
                            <a href="blogs.php">Software Design</a>
                            <a href="blogs.php">3D Design</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="comments-area sec-mar">
                    ...
                    <div class="single-comment">
                        <div class="author-thumb">
                            <img src="assets/img/inner-pages/comment-img-01.png" alt="">
                        </div>
                        <div class="comment-content">
                            ...
                            <p>Odio tellus, dignissim fermentumara purus nec, consequat dapibus metus.Vivamusut urna
                                world classo mauris, faucibus at egestas quis, fermentum egetonav neque. Duisonajt
                                pharetra lectus nec risusonota and we are always support our customer support
                                available.</p>
                        </div>
                    </div>
                    <div class="single-comment">
                        <div class="author-thumb">
                            <img src="assets/img/inner-pages/comment-img-02.png" alt="">
                        </div>
                        <div class="comment-content">
                            <div class="author-post">
                                <div class="author-info">
