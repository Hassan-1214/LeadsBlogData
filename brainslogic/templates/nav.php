...
<header class="header-area2 style-2 two">
    ...
    <div class="main-menu">
        ...
        <ul class="menu-list">
            <li class="<?= $a ?>"><a href="https://www.brainslogic.com">Home</a></li>
            <li class="<?= $b ?>"><a href="about.php">About</a></li>
            <li class="<?= $c ?>"><a href="services.php">Services</a></li>
<!--            <li class="--><?//= $d ?><!--"><a href="team">Team</a></li>-->
            <li class="<?= $e ?>"><a href="portfolio.php">Portfolio</a></li>
            <li class="<?= $d ?>"><a href="blogs.php">Blogs</a></li>
            <li class="<?= $f ?>"><a href="contact.php">Contact</a></li>
